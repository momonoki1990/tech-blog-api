...
func (r *categoryR) GetArticles() ArticleSlice {
	if r == nil {
		return nil
	}
	return r.Articles
...
func (o *Category) Articles(mods ...qm.QueryMod) articleQuery {
	...
	queryMods = append(queryMods,
		qm.Where("`articles`.`category_id`=?", o.ID),
	)
...
func (categoryL) LoadArticles(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCategory interface{}, mods queries.Applicator) error {
	var slice []*Category
	var object *Category
	...
	query := NewQuery(
		qm.From(`articles`),
		qm.WhereIn(`articles.category_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Category) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to populate default values for categories")
	}
...
func (o *Category) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to upsert for categories")
	}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to retrieve unique values for categories")
	}
